...
class Ui_Dialog_createTask(object):
    ...
    def retranslateUi(self, Dialog_createTask):
        ...
        Dialog_createTask.setWindowTitle(_translate("Dialog_createTask", "Create New Task"))
        self.label_3.setText(_translate("Dialog_createTask", "Goal:"))
        self.label.setText(_translate("Dialog_createTask", "Name:"))
